...
always_given_features = ['age', 'hemisphere_right', 'biological_sex_M', 'structure_VISl2/3', 'structure_VISl5', 'structure_VISl6a', 'structure_VISp1', 'structure_VISp2/3', 'structure_VISp4', 'structure_VISp5', 'structure_VISp6a', 'structure_VISpm2/3', 'structure_VISpm5', 'structure_VISpm6a', 'T-type Label_Lamp5', 'T-type Label_Pvalb', 'T-type Label_Serpinf1', 'T-type Label_Sncg', 'T-type Label_Sst', 'T-type Label_Vip']
...
valid_inputs[:, :1] = norm_col(valid_inputs[:, :1])
