...
def run_simulation(task):
    ...
    try:
        ...
        csv_path = f"/mnt/f/arbor_ubuntu/MORE_MOUSE_BITES/{folder_name}_{cell_name}_{counter}.csv"
...
if __name__ == "__main__":
    ...
    for total_count in range(10000):
        fit_params_path = f"/mnt/f/arbor_ubuntu/10k_randomized_jsons/random_genome_{total_count}.json"
        tasks.append((morph_path, fit_params_path, 'kimura', 'P7-control-for-TRAK2-MBD-14-003.CNG.swc', total_count))
